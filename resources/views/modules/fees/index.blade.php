    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm p-4 mb-4">
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    ...
                    <p class="text-muted m-0 mt-1" style="font-size: 0.9rem;">
                        Direct file path: <code>resources/views/modules/fees/index.blade.php</code>
                    </p>
                </div>
            </div>
            ...
            <div class="alert alert-info border-0 rounded-3 d-flex align-items-center gap-3">
                ...
                <div>
                    Aap is view file aur is ke controller class (<code>FeesController</code>) ke andar CRUD forms, tables, aur logic add kar ke Fee Management system bana sakte hain.
                </div>
            </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="card border-0 bg-light p-3 h-100 rounded-3">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h6 class="fw-bold m-0 text-dark">Collect Fee</h6>
                        </div>
                        <p class="text-muted small mb-0">Student custom payments aur vouchers submit karein.</p>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="card border-0 bg-light p-3 h-100 rounded-3">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h6 class="fw-bold m-0 text-dark">Manage Fees</h6>
                        </div>
                        <p class="text-muted small mb-0">Record updates, verify status, and pending vouchers.</p>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="card border-0 bg-light p-3 h-100 rounded-3">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h6 class="fw-bold m-0 text-dark">Ledger / Invoices</h6>
                        </div>
                        <p class="text-muted small mb-0">Overall collections history export karein.</p>
                    </div>
                </div>
            </div>
        </div>
