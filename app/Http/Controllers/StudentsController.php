        ...
        return DataTables::of($query)
            ...
            ->addColumn('actions', function ($row) {
                $viewBtn   = '<button class="btn btn-sm btn-outline-info view-student-btn"
                                data-id="' . $row->id . '" title="View Student">
                                <i class="bi bi-eye"></i>
                              </button>';

                $feeBtn    = '<button class="btn btn-sm btn-outline-success submit-fee-btn"
                                data-id="' . $row->id . '"
            ...
            ->rawColumns(['student_image', 'gender', 'fee_status', 'actions'])
            ->make(true);
    }

    /**
     * View single student detail (JSON for modal)
     */
